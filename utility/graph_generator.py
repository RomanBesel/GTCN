...
from simple_graphs import SimpleGraph, SimpleDirectedGraph, SimpleWeightedGraph, SimpleDirectedWeightedGraph
from graphs import Graph, DirectedGraph, WeightedGraph, DirectedWeightedGraph
from utility import *
...
class GraphFactory(object):
    ...
    def graph(self, nodes, edges, simple: bool, directed: bool, weighted: bool):
        if simple == True:
            ...
            elif (directed == True) & (weighted == True):
                return SimpleDirectedWeightedGraph(nodes, edges)
...
class RandomGraphFactory(GraphFactory):
